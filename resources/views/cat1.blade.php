...
<div class="album py-5 bg-dark">
  ...
  <img src="/assest/food.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Food items</h5>
    <p class="card-text">sandwichs,roles,beverages,ect..</p>
    <a href="/food/1" class="btn btn-success">view</a>
  </div>
</div>
         
        <div class="card" style="width: 18rem;">
  <img src="/assest/dish.jpg" class="card-img-top" alt="..." height="190 px" width="960 px">
  <div class="card-body">
    <h5 class="card-title">Dishes</h5>
    <p class="card-text">glasses,plates,bowls,cups,ect..</p>
    <a href="/dishes/1" class="btn btn-success">view</a>
  </div>
</div>
  ...
  <div class="card-body">
    ...
    <a href="/furnis/1" class="btn btn-success">view</a>
        ...
        <div class="card" style="width: 18rem;">
  <img src="/assest/dec.jpg" class="card-img-top" alt="..." height="190 px" width="960 px">
  <div class="card-body">
    <h5 class="card-title">Decorations</h5>
    <p class="card-text">paints,lights,ect..</p>
    <a href="/decoras/1" class="btn btn-success">view</a>
  </div>
</div>

        <div class="card" style="width: 18rem;">
  <img src="/assest/images.jpg" class="card-img-top" alt="..." height="190 px" width="960 px">
  <div class="card-body">
   ...
   <div class="card" style="width: 18rem;">
  <img src="/assest/sounds.jpg" class="card-img-top" alt="..." height="170 px" width="960 px">
  <div class="card-body">
    <h5 class="card-title">Sound systems</h5>
    <p class="card-text">sound speakers,bluetooth speakers,big speakers,ect..</p>
    <a href="/sounds/1" class="btn btn-success">view</a>
  </div>
</div> 
 </div>
